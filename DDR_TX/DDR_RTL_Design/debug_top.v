...
module edb_top (
    ...
    input  Axi_RREADY,
    input  Axi_RVALID,
    input  Axi_TesrWrTestEnd,
    input  Axi_TestDdrRdEnd,
    input  Axi_TestErr,
    input  Axi_TimeOut,
    ...
    input  DdrTest_WrPeriod_minimun_Cycle,
    ...
    input  [31:0] DdrTest_mux_reg_data,
    input  DdrTest_data_load,
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'ha2f7cf9774184efe9865cdc1b9ab333c ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 32 ),
        .PROBE0_TYPE        ( 3 ),
        .PROBE1_WIDTH       ( 8 ),
        ...
        .probe6                 ( Axi_BVALID ),
        .probe7                 ( Axi_DdrReset ),
        .probe8                 ( Axi_mux_reg_data ),
        .probe9                 ( Axi_RdAddr ),
        .probe10                    ( Axi_RDATA__31___0 ),
        .probe11                    ( Axi_RDATA__63__32 ),
        .probe12                    ( Axi_RDATA__95__64 ),
        .probe13                    ( Axi_RDATA_127__96 ),
        .probe14                    ( Axi_RDATA_159_128 ),
        .probe15                    ( Axi_RDATA_191_160 ),
        .probe16                    ( Axi_RDATA_223_192 ),
        .probe17                    ( Axi_RDATA_255_224 ),
        .probe18                    ( Axi_RdAva ),
        .probe19                    ( Axi_RdDataMode ),
        .probe20                    ( Axi_RdStartA ),
        .probe21                    ( Axi_RLAST ),
        .probe22                    ( Axi_RREADY ),
        .probe23                    ( Axi_RVALID ),
        .probe24                    ( Axi_TesrWrTestEnd ),
        .probe25                    ( Axi_TestDdrRdEnd ),
        .probe26                    ( Axi_TestErr ),
        .probe27                    ( Axi_TimeOut ),
        .probe28                    ( Axi_WDATA__31___0 ),
        .probe29                    ( Axi_WDATA__63__32 ),
        .probe30                    ( Axi_WDATA__95__64 ),
        .probe31                    ( Axi_WDATA_127__96 ),
        .probe32                    ( Axi_WDATA_159_128 ),
        .probe33                    ( Axi_WDATA_191_160 ),
        .probe34                    ( Axi_WDATA_223_192 ),
        .probe35                    ( Axi_WDATA_255_224 ),
        .probe36                    ( Axi_WLAST ),
        .probe37                    ( Axi_WrAddr ),
        .probe38                    ( Axi_WrDataMode ),
        .probe39                    ( Axi_WREADY ),
        .probe40                    ( Axi_WrEn ),
        .probe41                    ( Axi_WrStartA ),
        .probe42                    ( Axi_WVALID )
    );
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 16 ),
        .NUM_PROBE_OUT          ( 9 ),
        .UUID           ( 128'h6336cd334c9c46b39a02b4be4cc3c234 ),
        .PROBE_IN0_WIDTH        ( 1 ),
        .PROBE_IN1_WIDTH        ( 1 ),
        .PROBE_IN2_WIDTH        ( 24 ),
        .PROBE_IN3_WIDTH        ( 48 ),
        ...
        .PROBE_OUT6_INIT_VAL    ( 'h1000 ),
        .PROBE_OUT7_INIT_VAL    ( 'h1000 ),
        ...
        .probe_in14         ( DdrTest_mux_reg_data ),
        .probe_in15         ( DdrTest_data_load ),
        .probe_in16         ( 1'b0 ),
        .probe_in17         ( 1'b0 ),
        .probe_in18         ( 1'b0 ),
        .probe_in19         ( 1'b0 ),
