...
module edb_top (
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h56340475b3a24603a6a02116993a6736 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
        ...
        .probe9                 ( Axi_RREADY ),
        .probe10                    ( Axi_RLAST ),
        .probe11                    ( Axi_WrDataMode ),
        .probe12                    ( Axi_WrEn ),
        .probe13                    ( Axi_TestErr ),
        .probe14                    ( Axi_RdDataMode ),
        .probe15                    ( Axi_RdAva ),
        .probe16                    ( Axi_RDATA__95__64 ),
        .probe17                    ( Axi_RDATA_255_224 ),
        .probe18                    ( Axi_TimeOut ),
        .probe19                    ( Axi_WrStartA ),
        .probe20                    ( Axi_RdStartA ),
        .probe21                    ( Axi_TestDdrRdEnd ),
        .probe22                    ( Axi_TesrWrTestEnd ),
        .probe23                    ( Axi_DdrReset ),
        .probe24                    ( Axi_WrAddr ),
        .probe25                    ( Axi_WDATA__31___0 ),
        .probe26                    ( Axi_WDATA__63__32 ),
        .probe27                    ( Axi_WDATA__95__64 ),
        .probe28                    ( Axi_WDATA_127__96 ),
        .probe29                    ( Axi_WDATA_159_128 ),
        .probe30                    ( Axi_WDATA_191_160 ),
        .probe31                    ( Axi_WDATA_223_192 ),
        .probe32                    ( Axi_WDATA_255_224 ),
        .probe33                    ( Axi_RdAddr ),
        .probe34                    ( Axi_RDATA__31___0 ),
        .probe35                    ( Axi_RDATA__63__32 ),
        .probe36                    ( Axi_RDATA_127__96 ),
        .probe37                    ( Axi_RDATA_159_128 ),
        .probe38                    ( Axi_RDATA_191_160 ),
        .probe39                    ( Axi_RDATA_223_192 ),
        .probe40                    ( Axi_AADDR ),
        .probe41                    ( Axi_BVALID )
    );
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 14 ),
        .NUM_PROBE_OUT          ( 9 ),
        .UUID           ( 128'h68f2dab64d6d4941b9ecc4061ecfe80b ),
        .PROBE_IN0_WIDTH        ( 1 ),
        .PROBE_IN1_WIDTH        ( 1 ),
        .PROBE_IN2_WIDTH        ( 24 ),
        .PROBE_IN3_WIDTH        ( 48 ),
